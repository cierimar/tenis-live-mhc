...
(function () {
  ...
  function init() {
    ...
    if (themeToggle) {
      const MODES = ['light', 'dark', 'fluo', 'usopen', 'rosa', 'rosaoscuro', 'verdefluor', 'arcoiris', 'graffiti', 'argentina', 'wimbledon', 'rolandgarros', 'synthwave', 'lectura', 'veamna', 'boom', 'veamtu', 'laser', 'radioactivo', 'obdi', 'mandarina', 'rojo', 'amarillo', 'superamarillo'];
      const ICONS = { light: '&#9788;', dark: '&#9790;', fluo: '&#10038;', usopen: '&#9670;', rosa: '&#10047;', rosaoscuro: '&#10048;', verdefluor: '&#9827;', arcoiris: '&#9733;', graffiti: '&#10022;', argentina: '&#9737;', wimbledon: '&#9824;', rolandgarros: '&#9825;', synthwave: '&#9650;', lectura: '&#9998;', veamna: '&#9889;', boom: '&#10041;', veamtu: '&#9671;', laser: '&#9830;', radioactivo: '&#9762;', obdi: '&#10052;', mandarina: '&#127818;', rojo: '&#128308;', amarillo: '&#128993;', superamarillo: '&#11088;' };
      const TITLES = { light: 'Modo claro', dark: 'Modo oscuro', fluo: 'Modo flúor', usopen: 'Modo US Open', rosa: 'Modo rosa', rosaoscuro: 'Modo rosa oscuro', verdefluor: 'Modo verde flúor', arcoiris: 'Modo arcoíris', graffiti: 'Modo graffiti', argentina: 'Modo Argentina', wimbledon: 'Modo Wimbledon', rolandgarros: 'Modo Roland Garros', synthwave: 'Modo synthwave', lectura: 'Modo lectura', veamna: 'Modo veamna', boom: 'Modo boom', veamtu: 'Modo veamtu', laser: 'Modo laser', radioactivo: 'Modo radioactivo', obdi: 'Modo obdi', mandarina: 'Modo mandarina', rojo: 'Modo rojo', amarillo: 'Modo amarillo', superamarillo: 'Modo super amarillo' };
      const METACOLORS = { light: '#faf7f2', dark: '#16130e', fluo: '#0b0b12', usopen: '#071a38', rosa: '#ffe3ef', rosaoscuro: '#2b0a1d', verdefluor: '#071008', arcoiris: '#000000', graffiti: '#1b1720', argentina: '#070a10', wimbledon: '#0e1f16', rolandgarros: '#201008', synthwave: '#12081f', lectura: '#f7eedd', veamna: '#000000', boom: '#06001a', veamtu: '#000000', laser: '#0d0006', radioactivo: '#030602', obdi: '#060608', mandarina: '#0d0603', rojo: '#000000', amarillo: '#000000', superamarillo: '#000000' };
      let mode = 'light';
