...
(function () {
  ...
  function init() {
    ...
    if (themeToggle) {
      const MODES = ['broadcast', 'colors', 'verde', 'amarillo', 'claro'];
      const ICONS = { broadcast: '&#9679;', colors: '&#127752;', verde: '&#128154;', amarillo: '&#128993;', claro: '&#9788;' };
      const TITLES = { broadcast: 'Modo broadcast', colors: 'Modo colors', verde: 'Modo verde', amarillo: 'Modo amarillo', claro: 'Modo claro' };
      const METACOLORS = { broadcast: '#0b0e14', colors: '#000000', verde: '#000000', amarillo: '#000000', claro: '#faf7f2' };
      let mode = 'broadcast';
