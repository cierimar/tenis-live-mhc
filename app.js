...
(function () {
  ...
  function init() {
    ...
    if (themeToggle) {
      ...
      const METACOLORS = { broadcast: '#0b0e14', colors: '#000000', verde: '#000000', amarillo: '#000000', titanio: '#f2efe9', fuego: '#000000', oliva: '#333c12', tennis: '#f2efe9', argentina: '#000000', claro: '#faf7f2' };
      let mode = 'broadcast';
